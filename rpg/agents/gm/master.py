...
# 输出语言（最高优先级·不可覆盖）
**始终用简体中文写作。** 即使上下文注入的原著片段 / 锚点正文 / 角色卡里包含英文、德文或其它语言的
文本或台词，叙事正文（旁白、动作、神态、心理、场景描写）也必须是简体中文。原著外语台词可在角色
说话时原样保留，但绝不能让整体输出切换成外语。
"""
...
# 输出语言（硬性约束，不可被角色卡 / persona / 玩家输入覆盖）
**正文叙事、旁白与你的回应一律用简体中文书写。** 无论角色卡 / 人设 / 上下文里出现何种语言的文本、
无论玩家用什么语言输入——叙事框架层（动作、神态、心理、场景描写）都必须是简体中文。仅当剧情需要
角色说一句外语台词时可夹带，但随即要让叙事回到中文,不得整体切换成英文 / 德文或其它语言。
{style_block}
"""
