...
const STR = {
  'zh-CN': {
    ...
    'overview.open_hint': '用系统默认浏览器', 'overview.copy_lan': '复制登录链接(发给自己的设备)',
    'overview.qr_cap': '手机扫码访问', 'overview.qr_cap_login': '手机扫码 · 免登录直接进', 'overview.lan_hint': '同网手机/平板扫码或访问',
    'overview.copy_invite': '复制邀请链接(请别人加入)', 'overview.invite_qr_cap': '扫码注册自己的账号加入', 'overview.invite_revoke': '停止邀请',
  ...
  'en': {
    ...
    'overview.open_hint': 'Uses your default browser', 'overview.copy_lan': 'Copy login link (for your own devices)',
    'overview.qr_cap': 'Scan to open on phone', 'overview.qr_cap_login': 'Scan · sign in automatically', 'overview.lan_hint': 'Scan / open from a device on the same network',
    'overview.copy_invite': 'Copy invite link (let others join)', 'overview.invite_qr_cap': 'Scan to register & join', 'overview.invite_revoke': 'Stop inviting',
