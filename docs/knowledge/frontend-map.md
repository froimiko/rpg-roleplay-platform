...
整页视图:`admin.jsx`(**已拆薄为转发壳**,实现住 `components/admin/`)、`cards.jsx`、`saves.jsx`(**已拆薄为路由壳**,实现住 `components/saves/`)、`feedback.jsx`、`device.jsx`、`rath.jsx`(RATH 观测台)、`tavern.jsx`、`md-editor.jsx`(三栏 IDE 剧本编辑器)、`script-review.jsx`、`script-edit-canon.jsx`/`script-edit-worldbook.jsx`、`script-modules-panel.jsx`。
